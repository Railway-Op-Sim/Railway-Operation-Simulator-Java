...
public class BuildModifyMenuController {
	...
	@FXML // fx:id="trackMenu1"
	private GridPane trackMenu1; // Value injected by FXMLLoader
	...
	@FXML // fx:id="tightCurve2Image"
	private ImageView tightCurve2Image; // Value injected by FXMLLoader
...
// ** Bridge and Underpass Toggles and Images**
	...
	void changeAspect(ActionEvent event) {
		...
		case TWO:
			...
			BuildModifyMenuActions.changeToShuntSignalGraphic(signalLeftTrackImage, signalRightTrackImage,
					signalUpTrackImage, signalDownTrackImage, signalLeftUpTrackImage, signalRightUpTrackImage,
					signalLeftDownTrackImage, signalRightDownTrackImage);
		...
		case SHUNT:
			...
			BuildModifyMenuActions.changeToNormalSignalGraphic(signalLeftTrackImage, signalRightTrackImage,
					signalUpTrackImage, signalDownTrackImage, signalLeftUpTrackImage, signalRightUpTrackImage,
					signalLeftDownTrackImage, signalRightDownTrackImage);
